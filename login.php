...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" method="post" action="login.php" id="login" name="login" autocomplete="off">
...
if(isset($_POST['submit'])){
  ...
  $query=mysqli_query($conn,"select * from jobseeker where email='$email' and psd='$pass' ");
